...
namespace Simulatorqueue {
	...
	public:
		MyForm(void)
		{
			...
			g = CreateGraphics();
			rand = gcnew Random();
			DrawPen = gcnew Pen(Color::DarkCyan);
			DrawPen->Width = 15.0;
...
#pragma region Windows Form Designer generated code
			 ...
			 void InitializeComponent(void)
			 {
				 ...
				 // textBox3
				 // 
				 this->textBox3->Font = (gcnew System::Drawing::Font(L"Roboto", 11.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
					 static_cast<System::Byte>(204)));
				 ...
				 // textBox4
				 // 
				 this->textBox4->Font = (gcnew System::Drawing::Font(L"Roboto", 11.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
					 static_cast<System::Byte>(204)));
				 ...
				 this->textBox5->Font = (gcnew System::Drawing::Font(L"Roboto", 11.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
					 static_cast<System::Byte>(204)));
				 ...
				 this->textBox6->Font = (gcnew System::Drawing::Font(L"Roboto", 11.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
					 static_cast<System::Byte>(204)));
				 ...
				 this->label7->Size = System::Drawing::Size(366, 29);
...
#pragma endregion
	...
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		try
		{
			...
			label7->ForeColor = System::Drawing::Color::LightCyan;
			stop = 1;
		}
		catch (...)
		{
	...
	private: System::Void timer1_Tick(System::Object^  sender, System::EventArgs^  e) {
		...
		textBox6->Text = Convert::ToString(PopCount);
			 ...
			 void Clear()
			 {
				 double start = 360 * (MaxSize - queue->Count()+1) / MaxSize;
				 double finish = 360 * queue->Count() / MaxSize;
				 g->DrawArc(ClearPen, CenterX, CenterY, Height, Width, start, finish);
			 }
			 void Draw()
			 {
				 int start = 360 * (MaxSize - queue->Count() + 1) / MaxSize;
				 int finish = 360 * queue->Count() / MaxSize;
